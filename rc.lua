...
-- Own addition for gaps and some widgets
require("vain")
...
client.connect_signal("manage", function (c, startup)
    ...
    if not startup then
        ...
        -- i.e. put it at the end of others instead of setting it master.  -- awful.client.setslave(c)
